...
<body>
    <div class="jumbotron">
        ...
        <?php if (isset($usuario)) { ?>
            ...
            <a class="btn btn-primary btn-lg" href="clientes.php" role="button">Administrar Clientes</a>
        ...
        <?php } else { ?>
            ...
            <a class="btn btn-primary btn-lg" href="clientes.php" role="button">Ver Clientes</a>
        <?php } ?>
        </p>
        <p class="lead">
